...
- (void)testObjectInTopBar {
    NSString *entityName = @"Bar";
    
    [DKEntity destroyAllEntitiesForName:entityName error:NULL];
    
    // Insert
    DKEntity *object = [DKEntity entityWithName:entityName];
    [object setObject:@"76 Narrow Street London E14 8BP" forKey:@"address"];
    [object setObject:@"The Grapes Pub" forKey:@"barName"];
    [object setObject:@"$" forKey:@"cost"];
    [object setObject:@"51.508861" forKey:@"latitude"];
    [object setObject:@"-0.033969" forKey:@"longitude"];
    [object setObject:@"100" forKey:@"negativeVotes"];
    [object setObject:@"50" forKey:@"overallRating"];
    [object setObject:@"100" forKey:@"positiveVotes"];
    [object setObject:@"S" forKey:@"size"];
    [object setObject:@"001" forKey:@"uniqueId"];
    [object setObject:@"http://www.thegrapes.co.uk/" forKey:@"websiteURL"];
    ...
    NSString *barName = [object objectForKey:@"barName"];
    NSString *address = [object objectForKey:@"address"];
    
    STAssertTrue(oid.length > 0, @"result map should have field '_id'");
    STAssertEqualObjects(barName, @"The Grapes Pub", @"result map should have name field set to 'Erik', is '%@'", barName);
    STAssertEqualObjects(address, @"76 Narrow Street London E14 8BP", @"result map should have surname field set to 'Aigner', is '%@'", address);
    ...
    // Update
    [object setObject:@"200" forKey:@"negativeVotes"];
    [object setObject:@"300" forKey:@"positiveVotes"];
    ...
    // Public ID
    error = nil;
    NSURL *publicURL = [object generatePublicURLForFields:[NSArray arrayWithObject:@"barName"]
                                                    error:&error];
    ...
    STAssertEqualObjects(pubName, @"The Grapes Pub", @"public URL should return 'The Grapes Pub', did return '%@'", pubName);
